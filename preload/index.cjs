...
contextBridge.exposeInMainWorld('joggl', {
  ...
  jira: {
    ...
    submitWorklog: (issueIdOrKey, startTs, endTs, comment) =>
      call('jira:submitWorklog', { issueIdOrKey, startTs, endTs, comment }),
    updateWorklog: (issueIdOrKey, worklogId, startTs, endTs, comment) =>
      call('jira:updateWorklog', { issueIdOrKey, worklogId, startTs, endTs, comment }),
