...
export const SHORTCUTS = [
  ...
  },
  {
    ...
    keys: [
      ...
      ['Click empty grid', 'Mark that day, and put the selection down. This is the day a paste lands on'],
      ['Double click empty grid', 'Add time there — the quick-entry popup, at the hour clicked'],
      ...
      ['Ctrl + drag', 'Copy instead of moving — the whole selection if the block is in it. The originals stay put and ghosts follow the cursor. Let Ctrl go to call it off'],
